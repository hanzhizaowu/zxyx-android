...
public class VideoCompressor {
    ...
    public static void compress(Context context, String inputFile, String outputFile, final VideoCompressListener callback) {
        String cmd = "-threads 2 -y -i " + inputFile + " -strict -2 -vcodec libx264 -preset ultrafast -crf 28 -acodec copy -ac 2 -s 1280*720 " + outputFile;
        ...
        try {
            FFmpeg.getInstance(context).execute(command, new ExecuteBinaryResponseHandler() {
                ...
                public void onProgress(String message) {
                    if (callback != null) {
                        //callback.onProgress("Compress video successed!");
