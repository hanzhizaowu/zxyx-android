...
public class VideoTrimmerUtil {
  ...
  public static final int RECYCLER_VIEW_PADDING = Utils.dp2px(35);
  private static final int THUMB_HEIGHT = Utils.dp2px(50);
    ...
    try {
      ...
      FFmpeg.getInstance(context).execute(command, new ExecuteBinaryResponseHandler() {
        ...
        @Override public void onSuccess(String s) {
          if (BuildConfig.DEBUG) Log.i(TAG, "trim infile is:"+inputFile+" , out file is:"+tempOutFile);
          callback.onFinishTrim(tempOutFile, (int)(endMs - startMs));
        }
        ...
        try {
          ...
          for (long i = 0; i < totalThumbsCount; ++i) {
            ...
            try {
              ...
              int THUMB_WIDTH = (SCREEN_WIDTH_FULL - RECYCLER_VIEW_PADDING * 2) / VIDEO_MAX_TIME;
