...
public class FeedRepository {
    ...
    private final MutableLiveData<RetrofitResponseData<List<FeedDto>>> loginResult = new MutableLiveData<>();
    ...
    public LiveData<RetrofitResponseData<List<FeedDto>>> getFeedPage(Long userId, Long photoId) {
        ...
        Observable<RetrofitResponseData<List<FeedDto>>> observable = feedApis.getFeedPage(userId, photoId, 10);
